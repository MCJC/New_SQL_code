...
(
         ...
         SELECT F =  0,  G =  'ARTICLE 24 - Every person has the right to have freedom of ethical convictions, of conscience and of religion, and to have or to adopt, as the case may be, the one of her preference. Such freedom includes the right to participate, individually or collectively, in both public and private ceremonies, worship or religious acts of the respective cult, as long as they are not a felony or a misdemeanor punished by law. No person is allowed to use these public acts of religious expression with political ends, for campaigning or as means of political propaganda.'

          SELECT F = Z , 0 G =  'ARTICLE 24 - Every person has the right to have freedom of ethical convictions, of conscience and of religion, and to have or to adopt, as the case may be, the one of her preference. Such freedom includes the right to participate, individually or collectively, in both public and private ceremonies, worship or religious acts of the respective cult, as long as they are not a felony or a misdemeanor punished by law. No person is allowed to use these public acts of religious expression with political ends, for campaigning or as means of political propaganda.'
UNION ALL SELECT F = Z , 0.5 G =  'ARTICLE 75 - The Roman, Catholic, Apostolic Religion is that of the State, which contributes to its maintenance, without preventing the free exercise in the Republic of other beliefs that do not oppose themselves to the universal morality or good customs.'
UNION ALL SELECT F = Z , 0.67 G =  'Article 22. 7. To the extent that it is necessary, the rights and freedoms set out in this section may be made subject to such limitations prescribed by law- a.to protect- i.the rights and freedoms of other persons; or ii.public safety, public order, public morality or public health; or b.to prevent public nuisance. (CP 2016)'
UNION ALL SELECT F = Z , 0.67 G =  'According to Constitution Articles 12 and 13, "" The official religion of Iran is Islam and the Twelver Ja''farî school [in usul al-Dîn and fiqh], and this principle will remain eternally immutable. Other Islamic schools, including the Hanafî, Shafi''î, Malikî, Hanbalî, and Zaydî, are to be accorded full respect, and their followers are free to act in accordance with their own jurisprudence in performing their religious rites. These schools enjoy official status in matters pertaining to religious education, affairs of personal status (marriage,
...
UNION ALL SELECT F = Z , 0 G =  'Every person shall have the right to freedom of religion including the freedom to change his religion and the right, either alone or in community with others and both in public and in private, to manifest and propagate his religion in worship, teaching, practice and observance. (CP 2011)'
UNION ALL SELECT F = Z , 0 G =  'Article 45  The State guarantees the freedom of conscience and religion, subject to the public order and respect to good customs. (CP 2015)'
UNION ALL SELECT F = Z , 0 G =  'Article 5  All religious sects are free in Uruguay. The State supports no religion whatever. (CP 2004) '
UNION ALL SELECT F = Z , 0.33 G =  'ARTICLE 10  Private actions of persons which do not in any way affect the public order or prejudice others shall be outside the jurisdiction of the magistrates. (CP 2016)'
)
...
SELECT [v_Basic_row]
  ...
  FROM [forum_ResAnal].[dbo].[vr___06_cDB_LongData_ALL_byCYQ]
 where 
        (       [Ctry_EditorialName]        like 'Mexico'
            and [Question_Year]             in  (2013,2014)
            and [QA_std]                    in  ('GRI_01')                  )
    or
        (       [Ctry_EditorialName]        like 'Costa Rica'
            and [Question_Year]             in  (2011, 2012, 2013, 2014)
            and [QA_std]                    in  ('GRI_01')                  )
    or
        (       [Ctry_EditorialName]        like 'Fiji'
            and [Question_Year]             in  (2013, 2014)
            and [QA_std]                    in  ('GRI_02')                  )
    or
        (       [Ctry_EditorialName]        like 'Iran'
            and [Question_Year]             in  (2011, 2012, 2013, 2014)
            and [QA_std]                    in  ('GRI_02')                  )
    or
        (       [Ctry_EditorialName]        like 'Jamaica'
            and [Question_Year]             in  (2011, 2012, 2013, 2014)
            and [QA_std]                    in  ('GRI_02')                  )
    or
        (       [Ctry_EditorialName]        like 'Dominican Republic'
            and [Question_Year]             in  (2011, 2012, 2013, 2014)
            and [QA_std]                    in  ('GRI_01')                  )
    or
        (       [Ctry_EditorialName]        like 'Uruguay'
            and [Question_Year]             in  (2011, 2012, 2013, 2014)
            and [QA_std]                    in  ('GRI_01')                  )
    or
        (       [Ctry_EditorialName]        like 'Uruguay'
...
Country	Year(s)	Variable	Old Score	New Score	New Text	Details
Mexico	2013, 2014	GRI_01	0.5	0	ARTICLE 24 - Every person has the right to have freedom of ethical convictions, of conscience and of religion, and to have or to adopt, as the case may be, the one of her preference. Such freedom includes the right to participate, individually or collectively, in both public and private ceremonies, worship or religious acts of the respective cult, as long as they are not a felony or a misdemeanor punished by law. No person is allowed to use these public acts of religious expression with political ends, for campaigning or as means of political propaganda.	Constitutional change in 2012 (took effect in 2013) revised the wording of Article 24, which has to do with religious freedom. The new text clearly allows for freedom of religion, but the outdated text continued to be cited in 2013 and 2014. 
Costa Rica	2011, 2012, 2013, 2014	GRI_01	0	0.5	ARTICLE 75 - The Roman, Catholic, Apostolic Religion is that of the State, which contributes to its maintenance, without preventing the free exercise in the Republic of other beliefs that do not oppose themselves to the universal morality or good customs.	The wording of Article 75 has not changed since coding began, yet coders in 2011-2014 changed the score for GRI_01 from 0.5 to 0. The text clearly indicates a 0.5 score, so I propose returning to the original, correct coding that was used from 2007-2010.
Fiji	2013, 2014	GRI_02	0.33	0.67	Article 22. 7. To the extent that it is necessary, the rights and freedoms set out in this section may be made subject to such limitations prescribed by law- a.to protect- i.the rights and freedoms of other persons; or ii.public safety, public order, public morality or public health; or b.to prevent public nuisance. (CP 2016)	Coders indicated a constitution change in 2013, but did not include the correct text and incorrectly lowered the GRI_02 score from 0.67 in previous years to a 0.33, even though such a promotion in score was not supported by the text
Iran	2011, 2012, 2013, 2014	GRI_02	0	0.67	"According to Constitution Articles 12 and 13, "" The official religion of Iran is Islam and the Twelver Ja'farî school [in usul al-Dîn and fiqh], and this principle will remain eternally immutable. Other Islamic schools, including the Hanafî, Shafi'î, Malikî, Hanbalî, and Zaydî, are to be accorded full respect, and their followers are free to act in accordance with their own jurisprudence in performing their religious rites. These schools enjoy official status in matters pertaining to religious education, affairs of personal status (marriage,
divorce, inheritance, and wills) and related litigation in courts of law. In regions of the country where Muslims following any one of these schools of fiqh constitute the majority, local regulations, within the bounds of the jurisdiction of local councils, are to be in accordance with the respective school of fiqh, without infringing upon the rights of the followers of other schools. [...] Zoroastrian, Jewish, and Christian Iranians are the only recognized religious minorities, who, within the limits of the law, are free to perform their religious rites and ceremonies, and to act according to their own canon in matters of personal affairs and religious education. (CP 2016) | The constitution and other laws and policies severely restrict freedom of religion. The constitution declares the “official religion is Islam and the doctrine followed is that of Ja’afari Shiism.” The constitution states all laws and regulations must be based on undefined “Islamic criteria” and official interpretation of sharia (Islamic law). The constitution provides Sunni Muslims a degree of religious freedom, and states that, “within the limits of the law,” Zoroastrians, Jews, and Christians are the only recognized religious minorities with protected ability to worship freely and to form religious societies, as long as they do not proselytize. (IRF 2015)"	Coders changed the score to a 0 in 2011 despite no constitutional change. Text clearly indicates a 0.67 score, as only the rituals of approved groups are permitted.
Jamaica	2011, 2012, 2013, 2014	GRI_02	0.67	0	Every person shall have the right to freedom of religion including the freedom to change his religion and the right, either alone or in community with others and both in public and in private, to manifest and propagate his religion in worship, teaching, practice and observance. (CP 2011)	Jamaican constitution was amended in 2011 and the previously cited Article 21 was repealed, along with the text about provisions for order and morality. The new article (Article 17) does not have any qualifications.
Dominican Republic	2011, 2012, 2013, 2014	GRI_01	0.5	0	Article 45  The State guarantees the freedom of conscience and religion, subject to the public order and respect to good customs. (CP 2015)	Coders recoded this text in 2011 to a 0.5 despite no evidence of that score being warranted. Prior to 2011, GRI_01 was a 0.
Uruguay	2011, 2012, 2013, 2014	GRI_01	0.5	0	Article 5  All religious sects are free in Uruguay. The State supports no religion whatever. (CP 2004) 	This was the original text used by Brian to justify a 0 coding, and is still the same text in the current constitution. It is unclear why the coders changed this to a 0.5 in 2011.
Uruguay	2011, 2012, 2013, 2014	GRI_02	0.67	0.33	ARTICLE 10  Private actions of persons which do not in any way affect the public order or prejudice others shall be outside the jurisdiction of the magistrates. (CP 2016)	This was the original text used by Brian to justify a 0.33 coding, and is still the same text in the current constitution. It is unclear why the coders changed this to a 0.67 in 2011.
