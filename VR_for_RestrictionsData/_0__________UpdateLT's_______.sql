...
--	  !!dir /B /O "\\Mac\Home\Desktop\Desktop - Pew\SQL_code_at_desktop\VR_for_RestrictionsData"
/***************************************************************************************************************************************************************/
/***************************************************************************************************************************************************************/
USE  [forum_ResAnal]
GO
/***************************************************************************************************************************************************************/
/***************************************************************************************************************************************************************/
/***     SECTION 1: ALTER ALL VIEWS & RE-CREATE CORRESPONDING TABLES  (if structure of views should be updated)                                              ***/
/***************************************************************************************************************************************************************/
/*-------------------------------------------------------------------------------------------------------------------------------------------------------------*/
Print  '==> '
Print   
'--- ' + CONVERT (VARCHAR(19), SYSDATETIME()) + ' ==>  ALTER ALL VIEWS & RE-CREATE ALL TABLES  !!!   ---------------------------------------------------------- '
Print  '==> '
/*** ------------------------------------------------------------------------------------------------------------------------------------------------------- ***/
/*    --> store working directory (path) in a variable & execute scripts:                                                                                      */
----
--			 :setvar path "\\Mac\Home\Desktop\Desktop - Pew\SQL_code_at_desktop\VR_for_RestrictionsData"
--			   :r  $(path)\_0__01_VT___DSLong_NoAggr____.sql
--			   :r  $(path)\_0_002_VT___SemiWide_byCY____.sql
--			   :r  $(path)\_0_003_VT___SWde_nXt_byCY____.sql
--			   :r  $(path)\_0_004_VT___SrtdSWde_byCY____.sql
--			   :r  $(path)\_0_005_VT__cDBIndex_byRCY___R.sql
--			   :r  $(path)\_0_006_VT__cLongData__ALL___R.sql
--			   :r  $(path)\_0_007_VT__cLongDataRTeam___R.sql
--			   :r  $(path)\_0_008_VT__cLongDataWghtd___R.sql
--			   :r  $(path)\_0_009_VT__cWTopLines_ALL___R.sql
--			   :r  $(path)\_0_010_VT__cPubl_TopLines___R.sql
--			   :r  $(path)\_0_011_VT__cPubl_IxbyCtry___R.sql
--			   :r  $(path)\_0_012_VT__cPubl_R_byCtry___R.sql
/*** ------------------------------------------------------------------------------------------------------------------------------------------------------- ***/
Print  '==> '
Print   
'--- ' + CONVERT (VARCHAR(19), SYSDATETIME()) + ' ==>  ALL VIEWS have been ALTERED  &  ALL TABLES have been RE-CREATED !!!    ---------------------------------'
Print  '==> '
/*** ------------------------------------------------------------------------------------------------------------------------------------------------------- ***/
/***************************************************************************************************************************************************************/
