      ...
      (
          SELECT
                ...
                ,[Value]     = CASE
                                   WHEN
                                      ...
                                      AND(             [QA_std] LIKE 'GRI_19_'              +'[bcdefx]'
                                                    ...
                                                    OR [QA_std] LIKE 'SHI_0'  +'[4,5]'+'_d_x_'+'[1,2]'  )
                                   THEN    '1.00'
           ...
           WHERE          D.[Nation_fk]
             ...
             AND          D.[QA_std] NOT LIKE '%I_change'
...
AS
      (
          SELECT
                  M.Variable
                ,   [Value ]  = CAST(M.[Value] as numeric(12,2))
                ,   Wording   =  L.A_Wording
...
,[N2007] = STR(ISNULL(MAX([N2007]),0), 3,0)+'%'
,[P2007] = CAST(ISNULL(MAX([P2007]) ,0)  AS NVARCHAR(MAX))
,[N2008] = STR(ISNULL(MAX([N2008]),0), 3,0)+'%'
,[P2008] = STR(ISNULL(MAX([P2008]),0),12,0)
,[N2009] = STR(ISNULL(MAX([N2009]),0), 3,0)+'%'
,[P2009] = STR(ISNULL(MAX([P2009]),0),12,0)
,[N2010] = STR(ISNULL(MAX([N2010]),0), 3,0)+'%'
,[P2010] = STR(ISNULL(MAX([P2010]),0),12,0)
,[N2011] = STR(ISNULL(MAX([N2011]),0), 3,0)+'%'
,[P2011] = STR(ISNULL(MAX([P2011]),0),12,0)
,[N2012] = STR(ISNULL(MAX([N2012]),0), 3,0)+'%'
,[P2012] = STR(ISNULL(MAX([P2012]),0),12,0)
,[N2013] = STR(ISNULL(MAX([N2013]),0), 3,0)+'%'
,[P2013] = STR(ISNULL(MAX([P2013]),0),12,0)
,[N2014] = STR(ISNULL(MAX([N2014]),0), 3,0)+'%'
,[P2014] = STR(ISNULL(MAX([P2014]),0),12,0)
FROM
                [CTE03]
