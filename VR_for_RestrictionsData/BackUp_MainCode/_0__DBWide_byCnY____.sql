...
/***                                                                                                                                                         ***/
/***                                                                                                                                                         ***/
/***     >>>>>         This script creates semi-WIDE set of WORKING data from the 'Global Restriction on Religion Study'                           <<<<<     ***/
/***                                                                                                                                                         ***/
/***                    -  view: [GRSHRcode][dbo].[vr___02_wDB_Wide__by_Ctry&Year]  -> includes last wave of data, not loaded in [forum]                     ***/
