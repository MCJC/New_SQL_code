/***************************************************************************************************************************************************************/
Print 
'--- ' + CONVERT (VARCHAR(19), SYSDATETIME()) + ' ==>  script 0.005    ---------------------------------------------------------------------------------------- '
/***************************************************************************************************************************************************************/
/***                                                                                                                                                         ***/
/***                                                                                                                                                         ***/
/***     >>>>>         This script creates long set of indexes using final data from the 'Global Restriction on Religion Study'                    <<<<<     ***/
/***                                                                                                                                                         ***/
/***                    -  This set is based in lookup tables as sources (not in views as scripts before 0.004)                                              ***/
/***                    -  Set includes indexes by country and median indexes for region, and for the world.                                                 ***/
/***                       + the MEDIAN:                                                                                                                     ***/
/***                                     is the numerical value separating the higher half from the lower half of the data                                   ***/
/***                                     (it can differ from the mean).                                                                                      ***/
/***                                     We find it by arranging all the observations from lowest value to highest value                                     ***/
/***                                     and picking the middle one. If there is an even number of observations, median is                                   ***/
...
/***                     --------------------------+-----------------------------------+-----------------------------------+                                 ***/
/***                               1st step view:  |                                   |  [vr___05_]                       |                                 ***/
/***                     --------------------------+-----------------------------------+-----------------------------------+                                 ***/
/***                       2ns step lookup table:  |                                   |  [vr___05_cDB_Index_byCtryReg&Yr] |                                 ***/
/***                     --------------------------+-----------------------------------+-----------------------------------+                                 ***/
/***                                                                                                                                                         ***/
/***                                                                                                                                                         ***/
